...
namespace InduccionAPI.Controllers
{
    ...
    {
        private readonly IDepartamentosService _svc;
        public DepartamentosController(IDepartamentosService svc)
        {
            _svc = svc;
        }
        ...
        [HttpPut]
        [Authorize(Roles = "ADMIN")]
        public async Task<IActionResult> Update([FromBody] DepartamentoUpdateDto dto)
        {
